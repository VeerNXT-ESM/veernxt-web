...
**Starter prompt for exactly this: §27.11, added below (still accurate — PYQs/quizzes is still the next content set; §27.14's fixes don't change that).** Copy it into the fresh conversation rather than re-deriving context from scratch.
